...
const mockVehicles: Record<number, VehicleData> = {
  1: {
    specifications: {
      fuelType: "Petrol",
      bodyType: "SUV",
...
export default function CarDetails() {
  ...
  const [vehicleData, setVehicleData] = useState<VehicleData | undefined>(mockVehicles[vehicleId]);

  useEffect(() => {
    // In a real app, you would fetch the vehicle data from an API here
    // For now, we're using mock data
    setVehicleData(mockVehicles[vehicleId]);
  }, [vehicleId]);
          ...
          <div className="lg:col-span-7">
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-6 mt-4 mb-4 shadow-sm">
              ...
              <p className="text-gray-600 leading-relaxed">
                The {vehicleData.carDetails.carName} is a versatile and stylish SUV that combines comfort, practicality, and modern design. Featuring a spacious interior, advanced technology, and efficient performance, this vehicle is perfect for both urban commuting and weekend adventures. With its sleek exterior, comfortable ride, and range of modern features, it offers an exceptional driving experience for families and professionals alike.
              </p>
            ...
            <HowLeasingWorks />
            <Reviews {...vehicleData.reviewData} />
          </div>
