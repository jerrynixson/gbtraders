...
export default function ArticlePage({ params }: { params: { slug: string } }) {
  ...
  const fetchArticle = async () => {
    try {
      // Try to find the article in both news and blog collections
      ...
      // Combine all articles and find the one with matching slug
      ...
      const foundArticle = allArticles.find(article => article.slug === params.slug);
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Related Articles Section - You could implement this later */}
          <div className="mt-12">
