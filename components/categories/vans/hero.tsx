    ...
    <div className="relative mx-auto w-full max-w-[85rem] overflow-hidden rounded-2xl bg-gradient-to-br from-red-500 via-blue-600 to-red-700 shadow-xl">
      <div className="flex min-h-[400px] flex-col lg:flex-row rounded-2xl border border-white/20 bg-white/10 shadow-lg backdrop-filter backdrop-blur-xl">
        ...
        <div className="flex w-full flex-col justify-between p-4 sm:p-6 lg:w-1/3 bg-white/10 backdrop-blur-xl rounded-2xl lg:rounded-r-none order-2 lg:order-1">
          <div>
            <h2 className="mb-4 sm:mb-6 text-center text-lg sm:text-xl font-semibold text-white">Find Your Perfect Van</h2>
              ...
              <div className="h-full flex flex-col">
                ...
                <div className="p-4 grid grid-cols-2 gap-4">
                  ...
                  <div className="col-span-2 space-y-1.5">
                    ...
                    <div className="grid grid-cols-4 gap-1.5">
                      <Button variant="outline" className="h-6 rounded-lg text-xs px-1 bg-white/50 hover:bg-white/80">LWB</Button>
                      <Button variant="outline" className="h-6 rounded-lg text-xs px-1 bg-white/50 hover:bg-white/80">MWB</Button>
                      <Button variant="outline" className="h-6 rounded-lg text-xs px-1 bg-white/50 hover:bg-white/80">SWB</Button>
                      <Button variant="outline" className="h-6 rounded-lg text-xs px-1 bg-white/50 hover:bg-white/80">High Roof</Button>
                    </div>
                  </div>
                </div>
