...
export function Hero({
  ...
  const handleSearch = () => {
    if (onSearch) {
      onSearch(make, model, minPrice, maxPrice, bikeType);
    }
  };
    ...
    <div className="relative mx-auto w-full max-w-[85rem] overflow-hidden rounded-2xl bg-gradient-to-br from-red-500 via-blue-600 to-red-700 shadow-xl">
      <div className="flex min-h-[400px] flex-col lg:flex-row rounded-2xl border border-white/20 bg-white/10 shadow-lg backdrop-filter backdrop-blur-xl">
        ...
        <div className="flex w-full flex-col justify-between p-4 sm:p-6 lg:w-1/3 bg-white/10 backdrop-blur-xl rounded-2xl lg:rounded-r-none order-2 lg:order-1">
          <div>
            <h2 className="mb-4 sm:mb-6 text-center text-lg sm:text-xl font-semibold text-white">Find Your Perfect E-Bike</h2>
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent className="w-full rounded-xl sm:rounded-2xl">
                    {bikeTypes.map((type) => (
                      <DropdownMenuItem
                        key={type}
                        onSelect={() => setBikeType(bikeType === type ? null : type)}
                        className={`cursor-pointer text-sm ${
                          bikeType === type ? "bg-blue-100 font-semibold text-blue-800" : ""
                        }`}
                      >
                        {type}
                      </DropdownMenuItem>
            ...
            <div className="absolute inset-0 bg-white/80 backdrop-blur-3xl shadow-2xl shadow-inner rounded-2xl border border-white/30">
              <div className="h-full flex flex-col">
                ...
                <div className="p-4 grid grid-cols-2 gap-4">
                  ...
                  {/* Frame Size */}
                  <div className="space-y-1.5">
                    <h3 className="text-xs font-medium text-gray-600">Frame Size</h3>
                    <div className="grid grid-cols-4 gap-1.5">
                      <Button variant="outline" className="h-6 rounded-lg text-xs px-1 bg-white/50 hover:bg-white/80">S</Button>
                      <Button variant="outline" className="h-6 rounded-lg text-xs px-1 bg-white/50 hover:bg-white/80">M</Button>
                      <Button variant="outline" className="h-6 rounded-lg text-xs px-1 bg-white/50 hover:bg-white/80">L</Button>
                      <Button variant="outline" className="h-6 rounded-lg text-xs px-1 bg-white/50 hover:bg-white/80">XL</Button>
                    </div>
                  </div>
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="grid grid-cols-4 gap-1.5">
                      ...
                      <Button variant="outline" className="h-6 rounded-lg text-xs px-1 bg-white/50 hover:bg-white/80">Demo</Button>
                    </div>
                  </div>

                  {/* Battery Range */}
                  <div className="space-y-1.5">
                    <h3 className="text-xs font-medium text-gray-600">Battery Range</h3>
                    <div className="grid grid-cols-4 gap-1.5">
                      <Button variant="outline" className="h-6 rounded-lg text-xs px-1 bg-white/50 hover:bg-white/80">30mi+</Button>
                      <Button variant="outline" className="h-6 rounded-lg text-xs px-1 bg-white/50 hover:bg-white/80">50mi+</Button>
                      <Button variant="outline" className="h-6 rounded-lg text-xs px-1 bg-white/50 hover:bg-white/80">70mi+</Button>
                      <Button variant="outline" className="h-6 rounded-lg text-xs px-1 bg-white/50 hover:bg-white/80">100mi+</Button>
                    </div>
                  </div>

                  {/* Motor Type */}
                  <div className="col-span-2 space-y-1.5">
                    <h3 className="text-xs font-medium text-gray-600">Motor Type</h3>
                    <div className="grid grid-cols-4 gap-1.5">
                      <Button variant="outline" className="h-6 rounded-lg text-xs px-1 bg-white/50 hover:bg-white/80">Hub</Button>
                      <Button variant="outline" className="h-6 rounded-lg text-xs px-1 bg-white/50 hover:bg-white/80">Mid</Button>
                      <Button variant="outline" className="h-6 rounded-lg text-xs px-1 bg-white/50 hover:bg-white/80">Bosch</Button>
                      <Button variant="outline" className="h-6 rounded-lg text-xs px-1 bg-white/50 hover:bg-white/80">Shimano</Button>
                    </div>
                  </div>
                  ...
                  <div className="col-span-2 space-y-1.5">
                    ...
                    <div className="grid grid-cols-4 gap-1.5">
                      <Button variant="outline" className="h-6 rounded-lg text-xs px-1 bg-white/50 hover:bg-white/80">Lights</Button>
                      <Button variant="outline" className="h-6 rounded-lg text-xs px-1 bg-white/50 hover:bg-white/80">Fenders</Button>
                      <Button variant="outline" className="h-6 rounded-lg text-xs px-1 bg-white/50 hover:bg-white/80">Rack</Button>
