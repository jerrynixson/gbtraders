...
export default function AdvertisePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const requiredFields = ['category', 'make', 'model', 'year', 'price', 'fuelType', 'engineSize', 'color', 'description', 'co2Emission', 'call', 'mileage', 'transmission', 'registrationMonth', 'registrationNumber']
      const missingFields = requiredFields.filter(field => !formData[field as keyof AdvertisementForm])
    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="space-y-2">
          ...
          <Select value={formData.registrationMonth} onValueChange={(value) => handleSelectChange("registrationMonth", value)}>
            <SelectTrigger>
              <SelectValue placeholder="Select registration month" />
            </SelectTrigger>
            <SelectContent>
